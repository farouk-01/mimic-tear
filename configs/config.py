...
class MimicTearConfig(BaseModel):
    ...
    recording: RecordingConfig = RecordingConfig.model_validate(_raw.recording)
    ...
    def load_recordings(
        ...
        def _load_dir(directory: Path) -> list[SequenceDataset]:
            ...
            for path in directory.rglob(self.recording.video_file):
            ...
            for directory in recording_dir:
                recording = Recording.from_directory(directory, self.recording)
