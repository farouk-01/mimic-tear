...
class Process:
    ...
    def process_sequence(
        ...
        frame_dataset = self._load_frames_dataset(source=source)
        controller_dataset = self._load_controller_dataset(source=source)
        game_state_dataset = self._load_game_state_dataset(source=source)
