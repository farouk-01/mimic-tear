...
from mimic_tear.visualization.controller_layout import draw_controller_layout  # noqa: E402
from mimic_tear.dataset.transforms import build_eval_transform  # noqa: E402
from mimic_tear.game_state import game_state_tensor  # noqa: E402
...
if TYPE_CHECKING:
    from mimic_tear.visualization import HiResCamVisualizer


WINDOW_TITLE = "Mimic Tear Recording Replay"
...
def render_replay_frame(
    ...
    *,
    ...
    if cam_heatmap is not None:
        from mimic_tear.visualization import blend_heatmap
