...
from mimic_tear.dataset.transforms import build_eval_transform
from mimic_tear.game_state import (
    EldenRingStateReader,
    GameStateSampler,
    game_state_tensor,
    load_memory_profile,
)
from mimic_tear.policy import EldenRingPolicy, load_policy_checkpoint
from mimic_tear.paths import DEFAULT_GAME_STATE_PROFILE
from mimic_tear.recording.schema import ANALOG_COLUMNS, BUTTON_COLUMNS
from mimic_tear.recording.synchronization import FrameClockSynchronizer
...
def main() -> None:
    ...
    cam_toggle = None
    if args.cam_overlay:
        from mimic_tear.visualization import HiResCamOverlay, ToggleKey
